										...
										<div class="col-12 mb-4">
											<form action="<?= base_url('profile/edit') ?>" method="post" novalidate>
												<div class="form-group row">
													<label class="col-12 col-lg-3 col-form-label text-lg-left" for="txtName">Nama Lengkap</label>
												...
												<div class="form-group row">
													<label class="col-12 col-lg-3 col-form-label text-lg-left" for="txtEmail">Email</label>
													<div class="col-12 col-lg-9">
												...
												<?php if ($role == 'mahasiswa') { ?>
													<div class="form-group row">
														<label class="col-12 col-lg-3 col-form-label text-lg-left" for="txtNim">NIM</label>
														<div class="col-12 col-lg-9">
															<input type="text" class="form-control <?= form_error('txtNim') ? 'is-invalid' : 'ff' ?>" name="txtNim" id="txtNim" required value="<?= $mahasiswa->nim ?>" disabled>
															<div class="invalid-feedback">
																<?= form_error('txtNim'); ?>
															</div>
														</div>
													...
													<div class="form-group row">
														<label class="col-12 col-lg-3 col-form-label text-lg-left" for="txtTa">Judul Tugas Akhir</label>
														<div class="col-12 col-lg-9">
															<input type="text" class="form-control <?= form_error('txtTa') ? 'is-invalid' : '' ?>" name="txtTa" id="txtTa" required value="<?= set_value('txtTa') ? set_value('txtTa') : ($mahasiswa->judul_ta ? $mahasiswa->judul_ta : '') ?>">
															<div class="invalid-feedback">
																<?= form_error('txtTa'); ?>
															</div>
														</div>
													...
													<div class="form-group row">
														<label class="col-12 col-lg-3 col-form-label text-lg-left" for="txtDosbing1">Dosen Pembimbing I</label>
														<div class="col-12 col-lg-9">
															<select class="form-control <?= form_error('txtDosbing1') ? 'is-invalid' : '' ?>" name="txtDosbing1" disabled>
																<?php if ($mahasiswa->dosbing_1) { ?>
																	<option selected value="<?= $mahasiswa->dosbing_1->nip ?>"><?= $mahasiswa->dosbing_1->user->name ?></option>
																<?php } else { ?>
															...
															<div class="invalid-feedback">
																<?= form_error('txtDosbing1'); ?>
															</div>
														</div>
													</div>
													<div class="form-group row">
														<label class="col-12 col-lg-3 col-form-label text-lg-left" for="txtDosbing2">Dosen Pembimbing II</label>
														<div class="col-12 col-lg-9">
															<select class="form-control <?= form_error('txtDosbing2') ? 'is-invalid' : '' ?>" name="txtDosbing2" disabled>
																<?php if ($mahasiswa->dosbing_2) { ?>
																	<option selected value="<?= $mahasiswa->dosbing_2->nip ?>"><?= $mahasiswa->dosbing_2->user->name  ?></option>
																<?php } else { ?>
																	<option value="">Pilih dosen</option>
																<?php } ?>
																<?php foreach ($dosens as $dosen) { ?>
