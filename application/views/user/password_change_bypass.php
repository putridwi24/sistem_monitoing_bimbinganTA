...
if (!isset($role)) $role = '';
if (!isset($userNama)) $userNama = "undefined";
if (!isset($userEmail)) $userEmail = "undefined";
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Ganti Password User</h1>
						</div><!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="<?php echo base_url('mahasiswa/beranda') ?>">Beranda</a></li>
								<li class="breadcrumb-item active">Ganti Password User</li>
										...
										<div class="p-2 w-75">
											<form action="password_change" method="post">
												<div class="form-group row">
													<label class="col-12 col-lg-3 col-form-label text-lg-right" for="txtPasswordNew">Password Baru</label>
												...
												<div class="form-group row">
													<label class="col-12 col-lg-3 col-form-label text-lg-right" for="txtPasswordNewConfirm">Konfirmasi Password Baru</label>
													<div class="col-12 col-lg-9">
