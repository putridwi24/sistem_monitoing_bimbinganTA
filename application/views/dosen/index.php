...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<!-- /.card-header -->
								<div class="card-body ">
									<table class="table table-hover text-wrap " id="tabel-dosen" data-order='[[ 0, "asc" ]]' data-page-length='10'>
										<thead>
											<tr>
												<th>No</th>
												<th>Nama</th>
										...
										<tbody>
											...
											foreach ($dosens as $dosen) { ?>
												<tr>
													<td><?= $no++ ?></td>
													<td>
														<a href="<?= base_url('dosen/' . $dosen->nip) ?>">
															<?= $dosen->user->name ?>
														</a>
													</td>
													<td><?= $dosen->code_name ?></td>
													<td><?= $dosen->nip ?></td>
													<!-- <td>
			...
			<div class="modal-dialog">
				<div class="modal-content  ">
					...
					<div class="modal-body">
						...
						<div class="row mb-2">
							<div class="col">
								<a class="btn col btn-info" href="<?= base_url('dosen/import/format') ?>">
	...
	<script>
		...
		var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
			url: "<?= base_url('/dosen/import') ?>", // Set the url
			paramName: "file_dosen",
			thumbnailWidth: 80,
			thumbnailHeight: 80,
			parallelUploads: 20,
		...
		$(function() {
			...
			}).buttons().container().appendTo('#tabel-dosen_wrapper .col-md-6:eq(0)');
		});
	</script>
